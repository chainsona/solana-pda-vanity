...
### Added
- Added command-line arguments to the search tool via `clap`.
    - `-s/--suffix`: Set the vanity suffix (default: "pump").
    - `-t/--threads`: Set the number of threads manually.
    - `-p/--program-id`: Set the Program ID.
